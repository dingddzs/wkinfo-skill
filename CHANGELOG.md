...
## v1.5.5 — 2026-08-10 — 检索经验库新增"需求分析先行"方法论

**新增**：
- `references/retrieval-tips.md` 新增 ★需求分析先行 专节（7步法）：检索前先拆解当事人真实困惑、读用户分析笔记定检索命题、明确案例身份三要素（谁起诉×案由×语境）、对准法律关系方向、先查法律定义、正反+部分认定对照、看法院说理路径而非结果
- tips 新增：破产法领域主案例必须为管理人起诉的追收案（2026-08-07）、非破产语境案例仅作补强等反模式

**背景**：上海鼎晗破产股东抽逃出资案调研中，agent 数次因"找案例但不知道找什么样的案例"被用户逐题纠偏（案例语境不符、方向不对、主体错位），沉淀为方法论
